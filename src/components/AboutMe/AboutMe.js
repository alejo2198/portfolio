...
const AboutMe = () => {
    return (
        <section className={classes['about-section']}>
            ...
            <p className={classes['about-section__text']} >I’m a passionate Full-Stack developer who loves solving problems in innovative ways. You can trust that I will get the job done and be an asset to your tech department.</p>
